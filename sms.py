...
class SendSms():
    ...
    def KahveDunyasi(self):    
        try:    
            ...
            if len(kahve_dunyasi.json()["meta"]["messages"]["error"]) == 0:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> core.kahvedunyasi.com")
                self.adet += 1
            else:
                raise
        except:    
    ...
    def Mopas(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> mopas.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Tazi(self):
        try:
            ...
            if (r.json()["kod"]) == "0000":
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> mobileapiv2.tazi.tech")
                self.adet += 1
            else:
                raise
        except:
    ...
    def N11(self):
        try:
            ...
            if (r.json()["isSuccess"]) == True:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> mobileapi.n11.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Marti(self):
        try:
            ...
            if r.json()["isSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> customer.martiscooter.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Hey(self):
        try:
            ...
            if r.json()["IsSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> --> heyapi.heymobility.tech")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Bisu(self):
        try:
            ...
            if r.json()["errors"] == None:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> bisu.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Macro(self):
        try:
            ...
            if r.json()["successful"] == True:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> rest.macrocenter.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Ayyildiz(self):
        try:
            ...
            if r.json()["Success"] == True:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> api.altinyildizclassics.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Istegelsin(self):
        try:
            ...
            if r.json()["data"]["sendOtp2"]["alreadySent"] == False:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> prod.fasapi.net")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Pisir(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.json()["ok"] == "1":
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> api.pisir.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Hizliecza(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.json()["isSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> hizlieczaprodapi.hizliecza.net")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Ipragaz(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> ipapp.ipragaz.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Metro(self):
        try:
            ...
            if r.json()["status"] == "success":
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> feature.metro-tr.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Kumport(self):
        try:
            ...
            if r.text.replace("\"", "").split(",")[1].split(":")[1].lower() == "true":
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> online.kumport.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Qumpara(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> tr-api.fisicek.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Paybol(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.json()["status"] == 0:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> pyb-mobileapi.walletgate.io")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Migros(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.json()["successful"] == True:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> rest.migros.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Roombadi(self):
        try:
            ...
            if r.json()["remainingTime"] == 120:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> api.roombadi.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Joker(self):
        try:
            ...
            if r.json()["message"] == "Doğrulama kodu gönderildi.":
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> api.joker.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Clickme(self):
        try:
            ...
            if r.json()["isSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> dev-azure-mobile-api.clickmelive.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Happy(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> happy.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Komagene(self):
        try:
            ...
            if r.json()["Success"] == True:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> gateway.komagene.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Taksim(self):
        try:
            ...
            if r.json()["success"]== True:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> service.taksim.digital")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Tasdelen(self):
        try:
            ...
            if r.json()["Result"]== True:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> 94.102.66.162:80")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Tasimacim(self):
        try:
            ...
            r = requests.post(url=url, json=json)
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> server.tasimacim.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Unilever(self):
        try:
            ...
            if r.json()["status"] == 1:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> siparisdirekt.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Uysal(self):
        try:
            ...
            r = requests.post(url=url, json=json)
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> api.uysalmarket.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Yuffi(self):
        try:
            ...
            r = requests.post(url, json=json)
            if r.json()["success"] == True:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> api.yuffi.co")
                self.adet += 1
            else:
                raise
        except:
    ...
    def  Beefull(self):
        try:
            ...
            r = requests.post(url, json=json)
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX} ✔✔✔ {Style.RESET_ALL} ♛ Gönderildi♛ [{self.phone}] ==> app.beefull.io")
                self.adet += 1
            else:
                raise
        except:
